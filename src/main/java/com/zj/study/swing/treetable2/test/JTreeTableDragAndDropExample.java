...
/**
 * A simple example application for the JTreeTable, showing how to drag-and-drop
 * the cell contents (as a string) to a label.
 */
...
public class JTreeTableDragAndDropExample {
	...
	private static void installDragHandling(JTable table) {
		...
		DragGestureListener dragGestureListener = new DragGestureListener() {
			...
			public void dragGestureRecognized(DragGestureEvent dge) {
				...
				Transferable transferable = new StringSelection(valueString);
	...
	private static String extractString(Transferable transferable) {
		try {
			Object result = transferable.getTransferData(DataFlavor.stringFlavor);
