...
public class ReflectUtil {
	...
	private static final Set<String> INHERITED_ANNOTATION_METHODS = new HashSet(
			Arrays.asList("toString", "equals", "hashCode", "annotationType"));
	...
	public static <T> T getInterfaceInstance(Class<T> interfaceType)
		...
		if (impl == null) {
			throw new InstantiationException("Stripes needed to instantiate a property who's declared type as an "
	 ...
	 *
	 * <ul>
	 * <li>Uses the classes simple name instead of it's fully qualified
	 * name.</li>
	 ...
	 *
	 * @param clazz
	 *            the class who's properties to examine
	 * @param property
	 ...
	 * interface methods in private classes).
	 * </p>
	 *
	 * <p>
	 ...
	 * found the original method is returned.
	 * </p>
	 *
	 * @param m
	...
	public static Method findAccessibleMethod(final Method m) {
		...
		// Else, loop through the interfaces for the declaring class, looking
		// for a
	 ...
	 *
	 * @param clazz
	 *            the clazz who's fields to examine
	 * @param property
	 ...
	 * 
	 * @param clazz
	 *            the implementing class (or subclass)
	 * @param targetType
