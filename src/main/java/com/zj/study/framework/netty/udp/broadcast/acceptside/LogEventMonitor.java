package com.zj.study.framework.netty.udp.broadcast.acceptside;

import java.net.InetSocketAddress;

import com.zj.study.framework.netty.udp.LogConst;
...
public class LogEventMonitor {
	...
	public LogEventMonitor(InetSocketAddress address) {
		...
		bootstrap.group(group).channel(NioDatagramChannel.class)
				...
				// 允许端口重用
				.option(ChannelOption.SO_REUSEADDR, true).handler(new ChannelInitializer<Channel>() {
					@Override
