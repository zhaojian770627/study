package com.zj.study.framework.mongodb;
...
import com.zj.study.framework.mongodb.entity.Address;
import com.zj.study.framework.mongodb.entity.Favorites;
import com.zj.study.framework.mongodb.entity.User;

//spring Pojo的操作方式
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:/com/zj/study/framework/mongodb/mongodb.xml")
public class QuickStartSpringPojoTest {
	...
	public void testUpdate() {
		...
		System.out.println("--------------------->" + updateMulti.getMatchedCount());
	}
