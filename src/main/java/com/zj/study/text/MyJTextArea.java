 ...
 * @see JEditorPane
 */
public class MyJTextArea extends JTextComponent {
	...
	/**
	 * Constructs a new JTextArea with the given document model, and defaults for
	...
	/**
	 * Constructs a new JTextArea with the specified number of rows and columns, and
	 * the given model. All of the constructors feed through this constructor.
	 *
	 ...
	 * one isn't explicitly given. A new instance of PlainDocument is returned.
	 *
	 ...
	 * @see #getTabSize
	 * @beaninfo preferred: true bound: true description: the number of characters
	 *           to expand tabs to
	 */
	...
	/**
	 * Gets the number of characters used to expand tabs. If the document is null or
	 * doesn't have a tab setting, return a default of 8.
	 *
	...
	/**
	 * Sets the line-wrapping policy of the text area. If set to true the lines will
	 * be wrapped if they are too long to fit within the allocated width. If set to
	 * false, the lines will always be unwrapped. A <code>PropertyChange</code>
	 * event ("lineWrap") is fired when the policy is changed. By default this
	 * property is false.
	 *
	 * @param wrap indicates if lines should be wrapped
	 * @see #getLineWrap
	 * @beaninfo preferred: true bound: true description: should lines be wrapped
	 */
	...
	/**
	 * Gets the line-wrapping policy of the text area. If set to true the lines will
	 * be wrapped if they are too long to fit within the allocated width. If set to
	 * false, the lines will always be unwrapped.
	 *
	...
	/**
	 * Sets the style of wrapping used if the text area is wrapping lines. If set to
	 * true the lines will be wrapped at word boundaries (whitespace) if they are
	 * too long to fit within the allocated width. If set to false, the lines will
	 * be wrapped at character boundaries. By default this property is false.
	 *
	 * @param word indicates if word boundaries should be used for line wrapping
	 * @see #getWrapStyleWord
	 * @beaninfo preferred: false bound: true description: should wrapping occur at
	 *           word boundaries
	 */
	...
	/**
	 * Gets the style of wrapping used if the text area is wrapping lines. If set to
	 * true the lines will be wrapped at word boundaries (ie whitespace) if they are
	 * too long to fit within the allocated width. If set to false, the lines will
	 * be wrapped at character boundaries.
	 *
	 ...
	 *                                 greater or equal to the number of lines
	 *                                 contained in the document (as reported by
	 *                                 getLineCount).
	 */
	...
	/**
	 * Appends the given text to the end of the document. Does nothing if the model
	 * is null or the string is null or empty.
	 *
	 * @param str the text to insert
	 * @see #insert
	 */
	...
	/**
	 * Sets the number of rows for this TextArea. Calls invalidate() after setting
	 * the new value.
	 *
	 * @param rows the number of rows &gt;= 0
	...
	/**
	 * Defines the meaning of the height of a row. This defaults to the height of
	 * the font.
	 *
	 * @return the height &gt;= 1
	 */
	...
	/**
	 * Gets column width. The meaning of what a column is can be considered a fairly
	 * weak notion for some fonts. This method is used to define the width of a
	 * column. By default this is defined to be the width of the character
	 * <em>m</em> for the font used. This method can be redefined to be some
	 * alternative amount.
	 *
	...
	/**
	 * Returns the preferred size of the TextArea. This is the maximum of the size
	 * needed to display the text and the size requested for the viewport.
	 *
	 * @return the size
	 */
	 ...
	 * new font will be reflected, and calls revalidate().
	 *
	...
	/**
	 * Returns a string representation of this JTextArea. This method is intended to
	 * be used only for debugging purposes, and the content and format of the
	 ...
	 * to match the width of the viewport. This is implemented to return true if the
	 * line wrapping policy is true, and false if lines are not being wrapped.
	 *
	 ...
	 * JScrollPane. This uses the desired column and row settings if they have been
	 * set, otherwise the superclass behavior is used.
	 *
	 ...
	 * value of orientation. This is implemented to use the values returned by the
	 * <code>getRowHeight</code> and <code>getColumnWidth</code> methods.
	 * <p>
...
////////////////
	...
	/**
	 * Gets the AccessibleContext associated with this JTextArea. For JTextAreas,
	 * the AccessibleContext takes the form of an AccessibleJTextArea. A new
	 * AccessibleJTextArea instance is created if necessary.
	 *
	 * @return an AccessibleJTextArea that serves as the AccessibleContext of this
	 *         JTextArea
	 */
	...
	/**
	 * This class implements accessibility support for the <code>JTextArea</code>
	 * class. It provides an implementation of the Java Accessibility API
	 * appropriate to text area user-interface elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	 * compatible with future Swing releases. The current serialization support is
	 * appropriate for short term storage or RMI between applications running the
